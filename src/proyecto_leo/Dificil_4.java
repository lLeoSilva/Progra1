...
public class Dificil_4 extends JFrame {
    ...
    public Dificil_4() {
        ...
        for (int i = 0; i < vMatrix7x7.length; i++) {
            ...
            for (int j = 0; j < vMatrix7x7.length; j++) {
                ...
                if (!(vMatrix7x7[i][j] == vMatrix7x7[0][3]) && !(vMatrix7x7[i][j] == vMatrix7x7[1][2])//rojo//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[0][0]) && !(vMatrix7x7[i][j] == vMatrix7x7[0][2])//verde//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[2][1]) && !(vMatrix7x7[i][j] == vMatrix7x7[3][3])//azul//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[3][1]) && !(vMatrix7x7[i][j] == vMatrix7x7[2][4])//amarillo//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[1][3]) && !(vMatrix7x7[i][j] == vMatrix7x7[4][1])) {//naranja//
                ...
                } else if (vMatrix7x7[i][j] == vMatrix7x7[0][3]) {
                    vMatrix7x7[0][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());

                } else if (vMatrix7x7[i][j] == vMatrix7x7[1][2]) {
                    vMatrix7x7[1][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());

                } else if (vMatrix7x7[i][j] == vMatrix7x7[0][0]) {
                    vMatrix7x7[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[0][2]) {
                    vMatrix7x7[0][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[2][1]) {
                    vMatrix7x7[2][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[3][3]) {
                    vMatrix7x7[3][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[3][1]) {
                    vMatrix7x7[3][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[2][4]) {
                    vMatrix7x7[2][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[1][3]) {
                    vMatrix7x7[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[4][1]) {
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                    vMatrix7x7[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
    ...
    class Manejador9 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource().equals(vMatrix7x7[0][0]) || e.getSource().equals(vMatrix7x7[0][2])) {//Verde//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix7x7[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
                    vMatrix7x7[0][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[2][1]) || e.getSource().equals(vMatrix7x7[3][3])) {//Azul//
                if (vColor == 0) {
                    vMatrix7x7[0][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[1][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    ...
                    vMatrix7x7[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[2][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
                    vMatrix7x7[3][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[0][3]) || e.getSource().equals(vMatrix7x7[1][2])) {//Rojo//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix7x7[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[0][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vMatrix7x7[1][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vColor = 3;
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
                } else if (vColor != 0) {
                    vMatrix7x7[2][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[3][1]) || e.getSource().equals(vMatrix7x7[2][4])) {//Amarillo//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix7x7[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[3][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Amarillo.jpg")));
                    vMatrix7x7[2][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Amarillo.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[1][3]) || e.getSource().equals(vMatrix7x7[4][1])) {//Naranja//
                if (vColor == 0) {
                    vMatrix7x7[2][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[3][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[0][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    ...
                    vMatrix7x7[3][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[2][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Naranja.jpg")));
                    vMatrix7x7[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Naranja.jpg")));
