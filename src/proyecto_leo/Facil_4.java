...
public class Facil_4 extends JFrame {
    ...
    public Facil_4() {
        ...
        for (int i = 0; i < vMatrix5x5.length; i++) {
            ...
            for (int j = 0; j < vMatrix5x5.length; j++) {
                ...
                if (!(vMatrix5x5[i][j] == vMatrix5x5[4][0]) && !(vMatrix5x5[i][j] == vMatrix5x5[1][2])//rojo//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[4][1]) && !(vMatrix5x5[i][j] == vMatrix5x5[0][4])//verde//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[0][0]) && !(vMatrix5x5[i][j] == vMatrix5x5[2][2])) { //azul//
                    ...
                    vMatrix5x5[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                } else if (vMatrix5x5[i][j] == vMatrix5x5[0][4]) {
                    vMatrix5x5[0][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                    ...
                    vMatrix5x5[2][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                }
    ...
    class Manejador6 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource().equals(vMatrix5x5[4][1]) || e.getSource().equals(vMatrix5x5[0][4])) {//Verde//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix5x5[4][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[1][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
                    vMatrix5x5[0][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[0][0]) || e.getSource().equals(vMatrix5x5[2][2])) {//Azul//
                if (vColor == 0) {
                    vMatrix5x5[4][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[1][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    ...
                    vMatrix5x5[2][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[4][0]) || e.getSource().equals(vMatrix5x5[1][2])) {//Rojo//
