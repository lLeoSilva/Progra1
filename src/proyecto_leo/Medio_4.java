...
public class Medio_4 extends JFrame {
    ...
    public Medio_4() {
        ...
        for (int i = 0; i < vMatrix5x5.length; i++) {
            ...
            for (int j = 0; j < vMatrix5x5.length; j++) {
                ...
                if (!(vMatrix5x5[i][j] == vMatrix5x5[2][1]) && !(vMatrix5x5[i][j] == vMatrix5x5[4][2])//rojo//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[1][0]) && !(vMatrix5x5[i][j] == vMatrix5x5[4][0])//verde//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[4][1]) && !(vMatrix5x5[i][j] == vMatrix5x5[1][3])//azul//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[0][0]) && !(vMatrix5x5[i][j] == vMatrix5x5[1][1]))//amarillo//
                {
                    ...
                    vMatrix5x5[2][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador9());

                } else if (vMatrix5x5[i][j] == vMatrix5x5[4][2]) {
                    vMatrix5x5[4][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador9());

                } else if (vMatrix5x5[i][j] == vMatrix5x5[1][0]) {
                    vMatrix5x5[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador9());
                } else if (vMatrix5x5[i][j] == vMatrix5x5[4][0]) {
                    vMatrix5x5[4][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador9());
                    ...
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador9());
                } else if (vMatrix5x5[i][j] == vMatrix5x5[0][0]) {
                    vMatrix5x5[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador9());
                } else if (vMatrix5x5[i][j] == vMatrix5x5[1][1]) {
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador9());
                }
    ...
    class Manejador9 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource().equals(vMatrix5x5[1][0]) || e.getSource().equals(vMatrix5x5[4][0])) {//Verde//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix5x5[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix5x5[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
                    vMatrix5x5[4][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[4][1]) || e.getSource().equals(vMatrix5x5[1][3])) {//Azul//
                if (vColor == 0) {
                    vMatrix5x5[2][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[4][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    ...
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[2][1]) || e.getSource().equals(vMatrix5x5[4][2])) {//Rojo//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix5x5[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix5x5[2][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vMatrix5x5[4][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vColor = 3;
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
                } else if (vColor != 0) {
                    vMatrix5x5[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[0][0]) || e.getSource().equals(vMatrix5x5[1][1])) {//Amarillo//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix5x5[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[4][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Amarillo.jpg")));
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Amarillo.jpg")));
                    vColor = 4;
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
                } else if (vColor != 0) {
                    vMatrix5x5[4][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
