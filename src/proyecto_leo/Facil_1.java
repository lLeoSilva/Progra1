...
public class Facil_1 extends JFrame {
    ...
    public Facil_1() {
        ...
        setResizable(false);
        JPanel vPanel = new JPanel(new GridLayout(5, 5));
        ...
        vBoton.addActionListener(new Manejador6());
        ...
        for (int i = 0; i < vMatrix5x5.length; i++) {
            ...
            for (int j = 0; j < vMatrix5x5.length; j++) {
                ...
                if (!(vMatrix5x5[i][j] == vMatrix5x5[1][3]) && !(vMatrix5x5[i][j] == vMatrix5x5[3][2])//rojo//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[0][0]) && !(vMatrix5x5[i][j] == vMatrix5x5[3][1])//verde//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[1][1]) && !(vMatrix5x5[i][j] == vMatrix5x5[0][3])) { //azul//

                    vMatrix5x5[i][j].addActionListener(new ManejadorColores1());
                    vMatrix5x5[i][j].addMouseListener(new ManejadorMouse1());
                    vMatrix5x5[i][j].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Fondo2.jpg")));

                } else if (vMatrix5x5[i][j] == vMatrix5x5[1][3]) {
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                } else if (vMatrix5x5[i][j] == vMatrix5x5[3][2]) {
                    vMatrix5x5[3][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                } else if (vMatrix5x5[i][j] == vMatrix5x5[0][0]) {
                    vMatrix5x5[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                    ...
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                } else if (vMatrix5x5[i][j] == vMatrix5x5[0][3]) {
                    vMatrix5x5[0][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador6());
                }
    ...
    class Manejador6 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource().equals(vMatrix5x5[0][0]) || e.getSource().equals(vMatrix5x5[3][1])) {//Verde//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[3][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[1][1]) || e.getSource().equals(vMatrix5x5[0][3])) {//Azul//
                if (vColor == 0) {
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[3][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[3][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
                    vMatrix5x5[0][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[1][3]) || e.getSource().equals(vMatrix5x5[3][2])) {//Rojo//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix5x5[0][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vMatrix5x5[3][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vColor = 3;
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
                } else if (vColor != 0) {
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
    ...
    class ManejadorMouse1 implements MouseListener {
...
//                                        JOptionPane.showMessageDialog(null, "Has seleccionado NO.");
    ...
    class ManejadorColores1 implements ActionListener {
