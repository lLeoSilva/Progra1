...
public class Facil_3 extends JFrame {
    ...
    public Facil_3() {
        ...
        vBoton.addActionListener(new Manejador8());
        ...
        for (int i = 0; i < vMatrix5x5.length; i++) {
            for (int j = 0; j < vMatrix5x5.length; j++) {
                ...
                if (!(vMatrix5x5[i][j] == vMatrix5x5[0][1]) && !(vMatrix5x5[i][j] == vMatrix5x5[1][3])//rojo//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[1][1]) && !(vMatrix5x5[i][j] == vMatrix5x5[3][1])//verde//
                        && !(vMatrix5x5[i][j] == vMatrix5x5[3][2]) && !(vMatrix5x5[i][j] == vMatrix5x5[4][4])) {//azul//

                    vMatrix5x5[i][j].addActionListener(new ManejadorColores3());
                    vMatrix5x5[i][j].addMouseListener(new ManejadorMouse3());
                    ...
                    vMatrix5x5[i][j].addActionListener(new Manejador8());
                    ...
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador8());
                    ...
                    vMatrix5x5[3][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix5x5[i][j].addActionListener(new Manejador8());
    ...
    class Manejador8 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource().equals(vMatrix5x5[1][1]) || e.getSource().equals(vMatrix5x5[3][1])) {//Verde//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix5x5[0][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[3][2]) || e.getSource().equals(vMatrix5x5[4][4])) {//Azul//
                if (vColor == 0) {
                    vMatrix5x5[0][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[1][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix5x5[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[3][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix5x5[3][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix5x5[0][1]) || e.getSource().equals(vMatrix5x5[1][3])) {//Rojo//
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
    ...
    class ManejadorMouse3 implements MouseListener {
...
//                                        JOptionPane.showMessageDialog(null, "Has seleccionado NO.");
    ...
    class ManejadorColores3 implements ActionListener {
