...
public class Dificil_1 extends JFrame {
    ...
    public Dificil_1() {
        ...
        for (int i = 0; i < vMatrix7x7.length; i++) {
            ...
            for (int j = 0; j < vMatrix7x7.length; j++) {
                ...
                if (!(vMatrix7x7[i][j] == vMatrix7x7[0][0]) && !(vMatrix7x7[i][j] == vMatrix7x7[4][4])//rojo//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[0][6]) && !(vMatrix7x7[i][j] == vMatrix7x7[2][3])//verde//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[1][1]) && !(vMatrix7x7[i][j] == vMatrix7x7[1][4])//azul//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[1][5]) && !(vMatrix7x7[i][j] == vMatrix7x7[6][0])//amarillo//
                        && !(vMatrix7x7[i][j] == vMatrix7x7[1][0]) && !(vMatrix7x7[i][j] == vMatrix7x7[5][2])) {//naranja//
                    ...
                    vMatrix7x7[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());

                } else if (vMatrix7x7[i][j] == vMatrix7x7[4][4]) {
                    vMatrix7x7[4][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());

                } else if (vMatrix7x7[i][j] == vMatrix7x7[0][6]) {
                    vMatrix7x7[0][6].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[2][3]) {
                    vMatrix7x7[2][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[1][1]) {
                    vMatrix7x7[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[1][4]) {
                    vMatrix7x7[1][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[1][5]) {
                    vMatrix7x7[1][5].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[6][0]) {
                    vMatrix7x7[6][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[1][0]) {
                    vMatrix7x7[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                } else if (vMatrix7x7[i][j] == vMatrix7x7[5][2]) {
                    vMatrix7x7[5][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[i][j].addActionListener(new Manejador9());
                }
    ...
    class Manejador9 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource().equals(vMatrix7x7[0][6]) || e.getSource().equals(vMatrix7x7[2][3])) {//Verde//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix7x7[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[5][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[0][6].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
                    vMatrix7x7[2][3].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Verde.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[1][1]) || e.getSource().equals(vMatrix7x7[1][4])) {//Azul//
                if (vColor == 0) {
                    vMatrix7x7[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[4][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    vMatrix7x7[0][6].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesVerde1.jpg")));
                    ...
                    vMatrix7x7[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[5][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
                    vMatrix7x7[1][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Azul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[0][0]) || e.getSource().equals(vMatrix7x7[4][4])) {//Rojo//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix7x7[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[5][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vMatrix7x7[4][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Rojo.jpg")));
                    vColor = 3;
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
                } else if (vColor != 0) {
                    vMatrix7x7[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[6][0]) || e.getSource().equals(vMatrix7x7[1][5])) {//Amarillo//
                ...
                if (vColor == 0) {
                    ...
                    vMatrix7x7[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[5][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesNaranja1.jpg")));
                    vMatrix7x7[6][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Amarillo.jpg")));
                    vMatrix7x7[1][5].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Amarillo.jpg")));
...
//                    JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
            ...
            if (e.getSource().equals(vMatrix7x7[5][2]) || e.getSource().equals(vMatrix7x7[1][0])) {//Naranja//
                if (vColor == 0) {
                    vMatrix7x7[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[1][4].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
                    vMatrix7x7[0][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesRojo1.jpg")));
                    ...
                    vMatrix7x7[6][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[1][5].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAmarillo1.jpg")));
                    vMatrix7x7[1][0].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Naranja.jpg")));
                    vMatrix7x7[5][2].setIcon(new ImageIcon(getClass().getResource("/Imagenes/Seleccion_Naranja.jpg")));
//                    JOptionPane.showMessageDialog(null, vColor);
                    vColor = 5;
//                        JOptionPane.showMessageDialog(null, "Numero es:" + vColor);
                } else if (vColor != 0) {
                    vMatrix7x7[1][1].setIcon(new ImageIcon(getClass().getResource("/Imagenes/DiamantesAzul1.jpg")));
